...
export function getValuesAndTheirSelectors( attributes: IterableIterator<RegExpMatchArray> )
{
    ...
    for (let [_, name, value ] of attributes) {
        ...
        const property = variants.pop() as string // We force it to be a string here to safe an extra condition and overwrite the .pop method 
...
export default function generate( html )
{
